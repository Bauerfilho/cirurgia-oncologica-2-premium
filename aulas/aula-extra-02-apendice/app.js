/* app.js — bootstrap da Aula Extra 2 (Tumores de apêndice)
...
const PAGE_TITLES = {
  p1: 'Os três tumores de apêndice',
  p2: 'Neuroendócrino e a síndrome carcinoide',
  p3: 'Adenocarcinoma de apêndice',
  p4: 'Mucinoso e o pseudomixoma peritoneal',
  p5: 'Conduta intraoperatória: três critérios',
  p6: 'Citorredução e HIPEC',
  p7: 'Conduta pós-operatória, tipo a tipo',
  p8: 'Banca: três questões paradigmáticas',
};
const NAMESPACE = 'cironco2-aula-extra-02';
