/* app.js — bootstrap da Aula Extra 8 (Câncer de Testículo — tumor de células germinativas).
   ...
   Os 12 SVGs interativos usam a engine canônica (.hs-shape) wirada por initInteractive;
   testiculo-interactive.js é um stub no-op (não há comportamento além do hotspot). */
...
const PAGE_TITLES = {
  p1: 'Câncer de testículo: o tumor do homem jovem',
  p2: 'Criptorquidia e a hierarquia de risco',
  p3: 'Os dois subtipos germinativos',
  p4: 'A massa testicular indolor',
  p5: 'Exame físico e a disseminação',
  p6: 'Ultrassom: hipoecogênico e heterogêneo',
  p7: 'Os três marcadores tumorais',
  p8: 'Orquiectomia inguinal radical',
  p9: 'Prognóstico e a cisplatina',
  p10: 'Estadiamento: por que vem depois',
  p11: 'Diagnósticos diferenciais',
  p12: 'Fechamento: a conduta que decide tudo',
};
const NAMESPACE = 'cironco2-aula-extra-08';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // testiculo-interactive.js (script clássico) é um stub no-op: tudo é hotspot canônico
