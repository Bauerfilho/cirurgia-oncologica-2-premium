/* testiculo-interactive.js — Aula Extra 8 (Câncer de Testículo).
   Os 12 SVGs interativos desta aula usam a ENGINE CANÔNICA de hotspot
   ...
   clique/foco/teclado, e o painel .hotspot-detail[data-hs-detail-for="tesN"] recebe
...
(function () {
  ...
  window.TesticuloInteractive = { initAll: function () { /* no-op: engine canônica */ } };
})();
