/* app.js — bootstrap da Aula 06 (Nódulo pulmonar solitário e câncer de pulmão)
   Reusa o chassi compartilhado: router · quiz universal · interativos (hotspots).
   Página única long-scroll com 22 seções (p1…p22), hash-router SPA.
...
const PAGES = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'p11', 'p12', 'p13', 'p14', 'p15', 'p16', 'p17', 'p18', 'p19', 'p20', 'p21', 'p22'];
const PAGE_TITLES = {
  p1: 'O nódulo que quase passou batido',
  p2: 'Nódulo ou massa? A régua dos 3 cm (e a pegadinha do Harrison)',
  p3: 'Tamanho importa: o cutoff de 8 mm',
  p4: 'Lendo a calcificação: do bem e do mal',
  p5: 'O nódulo é do nódulo, mas o paciente também conta',
  p6: 'O que fazer com o nódulo: acompanhar, captar, ressecar',
  p7: 'De volta à paciente: por que ela pode só acompanhar',
  p8: 'O mapa do câncer de pulmão: dois grandes grupos',
  p9: 'Adenocarcinoma: o subtipo que dominou',
  p10: 'Epidermoide e grandes células: o central que cavita',
  p11: 'Bronquíolo-alveolar e a regra diferenciação × prognóstico',
  p12: 'Oat cell: o pequeno, agressivo e neuroendócrino',
  p13: 'Carga tabágica e os outros fatores de risco',
  p14: 'Por que nem todo tabagista tem câncer',
  p15: 'Como o câncer se manifesta — e para onde vai',
  p16: 'Pancoast e veia cava superior: as síndromes compressivas',
  p17: 'Síndromes paraneoplásicas: cada subtipo, sua assinatura',
  p18: 'Fechar o diagnóstico: a via de biópsia segue o tumor',
  p19: 'Prognóstico: por que o diagnóstico precoce muda tudo',
  p20: 'Rastrear ou não rastrear: MS contra as sociedades',
  p21: 'Estadiamento: até onde o câncer chegou',
  p22: 'TNM e tratamento: o que ressecar, o que não',
};
const NAMESPACE = 'cironco2-aula-06';
