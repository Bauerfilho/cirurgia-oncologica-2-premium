/* app.js — bootstrap da Aula Extra 3 (Câncer de canal anal)
...
const PAGE_TITLES = {
  p1: 'Identidade histológica',
  p2: 'Fatores de risco e o eixo HPV',
  p3: 'O ponto-chave: linfonodos inguinais',
  p4: 'Fechando o estadiamento por imagem',
  p5: 'O pulo do gato: esquema Nigro',
  p6: 'A sequência inteligente: químio antes da rádio',
  p7: 'Quando falha: a cirurgia de Miles',
  p8: 'Caso AMRIGS',
  p9: 'Banca: consolidação e armadilhas',
};
const NAMESPACE = 'cironco2-aula-extra-03';
