/* mediastino-interactive.js — Aula Extra 10 (Tumores do Mediastino).
   ...
   clique/foco/teclado, e o painel .hotspot-detail[data-hs-detail-for="medN"] recebe
...
(function () {
  ...
  window.MediastinoInteractive = { initAll: function () { /* no-op: engine canônica */ } };
})();
