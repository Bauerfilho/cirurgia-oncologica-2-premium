/* app.js — bootstrap da Aula Extra 10 (Tumores do Mediastino).
   ...
   mediastino-interactive.js é um stub no-op (não há comportamento além do hotspot). */
...
const NAMESPACE = 'cironco2-aula-extra-10';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // mediastino-interactive.js (script clássico) é um stub no-op: tudo é hotspot canônico
