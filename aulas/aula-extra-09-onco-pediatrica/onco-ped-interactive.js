/* onco-ped-interactive.js — Aula Extra 9 (Oncologia Pediátrica — neuroblastoma × tumor de Wilms).
   Os 9 SVGs interativos desta aula usam a ENGINE CANÔNICA de hotspot
   ...
   clique/foco/teclado, e o painel .hotspot-detail[data-hs-detail-for="opN"] recebe
...
(function () {
  ...
  window.OncoPedInteractive = { initAll: function () { /* no-op: engine canônica */ } };
})();
