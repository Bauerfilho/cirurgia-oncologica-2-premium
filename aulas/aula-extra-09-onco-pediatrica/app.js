/* app.js — bootstrap da Aula Extra 9 (Oncologia Pediátrica — neuroblastoma × tumor de Wilms).
   Reusa o chassi compartilhado: router · quiz universal · interativos (hotspots canônicos).
   Página única long-scroll com 9 seções (p1…p9), hash-router SPA.
   Header (brand · tema · home · hambúrguer direita) + menu overlay + page-nav + progress + PWA.
   Os 9 SVGs interativos usam a engine canônica (.hs-shape) wirada por initInteractive;
   onco-ped-interactive.js é um stub no-op (não há comportamento além do hotspot). */
...
const PAGE_TITLES = {
  p1: 'Câncer na infância: por que tudo cai em dois tumores',
  p2: 'Neuroblastoma: origem na crista neural',
  p3: 'Neuroblastoma: a massa e as catecolaminas',
  p4: 'Opsoclonia-mioclonia, metástases e o sinal do guaxinim',
  p5: 'Diagnóstico do neuroblastoma',
  p6: 'Tumor de Wilms: síndromes e rastreio',
  p7: 'Tumor de Wilms: a criança que está bem',
  p8: 'Wilms: diagnóstico, tratamento e anaplasia',
  p9: 'A bifurcação que vence a prova',
};
const NAMESPACE = 'cironco2-aula-extra-09';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // onco-ped-interactive.js (script clássico) é um stub no-op: tudo é hotspot canônico
