/* aula-04.js — bootstrap da Aula 4 (BÔNUS) — Tumores Hepáticos
   ...
   Mesma arquitetura das Aulas 1/2/3; PAGES/PAGE_TITLES próprios (14 páginas). */
...
const PAGE_TITLES = {
  p1:  'Mapa da aula: o fígado e seus tumores',
  p2:  'O caso da enfermeira: o tumor do bem que matou',
  p3:  'A regra de ouro: por que o fígado não se biopsia',
  p4:  'Ler a TC trifásica: TC ou RM? Qual fase?',
  p5:  'As duas perguntas: captação arterial e washout',
  p6:  'Os quatro padrões de captação',
  p7:  'Hemangioma: o mais comum de todos',
  p8:  'Hiperplasia nodular focal: a cicatriz central',
  p9:  'Adenoma: o duas-caras que sangra',
  p10: 'Hepatocarcinoma: cirrose, AFP e washout',
  p11: 'CHC: Child, Milão e o tratamento de Barcelona',
  p12: 'Metástases hepáticas: o tumor maligno mais comum',
  p13: 'Volumetria: fazer o fígado crescer para operar',
  p14: 'Síntese e respostas ao caso da enfermeira',
};
const NAMESPACE = 'cironco2-aula-04';
...
function initHeader() {
  ...
  // Tema (compartilha chave com o HUB e as Aulas 1/2/3)
